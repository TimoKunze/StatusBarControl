// StatBar.cpp: Implementation of DLL exports.
...
class StatBarModule :
    public CAtlDllModuleT<StatBarModule>
{

public:
  #ifdef UNICODE
		DECLARE_LIBID(LIBID_StatBarLibU)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_STATBAR, "{3B38E14E-2BC3-4f19-BC5D-77F80B610BBF}")
	#else
		DECLARE_LIBID(LIBID_StatBarLibA)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_STATBAR, "{DD765DAA-60B3-41e1-82DF-034A8806AD32}")
	#endif
};

StatBarModule _AtlModule;
