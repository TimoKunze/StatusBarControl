...
/// \brief <em>Maximum length of a status bar panel's text string</em>
///
/// This is the maximum length (in characters) of a panel's text string.
///
/// \remarks If we change this value, we also need to update the Doxygen comments in StatBar*.idl!\n
///          Beginning with comctl32.dll version 6.10 the panel text length isn't limited anymore.
///
/// \sa StatusBarPanel::get_Text
#define MAX_PANELTEXTLENGTH 127


//////////////////////////////////////////////////////////////////////
/// \name Status bar hit-testing
///
//@{
/// \brief <em>Not over a panel</em>
///
/// The specified point lies inside the control's client area, but is not over a panel.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_ONITEM, SBARHT_ABOVE, SBARHT_BELOW, SBARHT_TORIGHT, SBARHT_TOLEFT
#define SBARHT_NOWHERE 0x0001
/// \brief <em>On a panel</em>
///
/// The specified point lies on a panel.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_NOWHERE, SBARHT_ABOVE, SBARHT_BELOW, SBARHT_TORIGHT, SBARHT_TOLEFT
#define SBARHT_ONITEM 0x0002
/// \brief <em>Above the control's client area</em>
///
/// The specified point lies above the control's client area.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_NOWHERE, SBARHT_ONITEM, SBARHT_BELOW, SBARHT_TORIGHT, SBARHT_TOLEFT
#define SBARHT_ABOVE 0x0100
/// \brief <em>Below the control's client area</em>
///
/// The specified point lies below the control's client area.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_NOWHERE, SBARHT_ONITEM, SBARHT_ABOVE, SBARHT_TORIGHT, SBARHT_TOLEFT
#define SBARHT_BELOW 0x0200
/// \brief <em>To the right of the control's client area</em>
///
/// The specified point lies to the right of the control's client area.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_NOWHERE, SBARHT_ONITEM, SBARHT_ABOVE, SBARHT_BELOW, SBARHT_TOLEFT
#define SBARHT_TORIGHT 0x0400
/// \brief <em>To the left of the control's client area</em>
///
/// The specified point lies to the left of the control's client area.
///
/// \remarks Microsoft defines neither any \c SBARHT_* flags nor a \c SB_HITTEST message.
///
/// \sa SBARHT_NOWHERE, SBARHT_ONITEM, SBARHT_ABOVE, SBARHT_BELOW, SBARHT_TORIGHT
#define SBARHT_TOLEFT 0x0800
//@}
//////////////////////////////////////////////////////////////////////
...
/// \brief <em>Retrieves whether a panel index is a valid one</em>
///
/// \param[in] panelIndex The panel index to check.
/// \param[in] pStatBar The \c StatusBar object containing the panel.
///
/// \return \c TRUE if the panel index is valid; otherwise \c FALSE.
BOOL IsValidPanelIndex(int panelIndex, StatusBar* pStatBar);
/// \brief <em>Retrieves whether a panel index is a valid one</em>
///
/// \overload
///
/// \param[in] panelIndex The panel index to check.
/// \param[in] hWndStatBar The status bar control containing the panel.
///
/// \return \c TRUE if the panel index is valid; otherwise \c FALSE.
BOOL IsValidPanelIndex(int panelIndex, HWND hWndStatBar);
...
/// \brief <em>Calls \c SendMessage catching access violations</em>
///
/// This function calls \c SendMessage catching access violations that the call is throwing. This is a hack
/// required for \c SB_GETTIPTEXT which is poorly implemented.
///
/// \param[in] hWnd The \c hWnd parameter to be passed to \c SendMessage.
/// \param[in] message The \c Msg parameter to be passed to \c SendMessage.
/// \param[in] wParam The \c wParam parameter to be passed to \c SendMessage.
/// \param[in] lParam The \c lParam parameter to be passed to \c SendMessage.
/// \param[out] caughtAnAccessViolation Will be set to \c TRUE if an access violation was caught and to
///             \c FALSE otherwise.
///
/// \return The return value of the \c SendMessage call.
///
/// \sa StatusBar::OnToolTipGetDispInfoNotificationA, StatusBar::OnToolTipGetDispInfoNotificationW
