...
/// \brief <em>The control's "String Properties" property page</em>
///
/// This class contains the control's "String Properties" property page.
///
/// \sa StatusBar, CommonProperties
//////////////////////////////////////////////////////////////////////
...
protected:
	...
	struct Properties
	{
		...
		/// \brief <em>The buffered value of the \c CustomCapsLockText property</em>
		CAtlString customCapsLockText;
		/// \brief <em>The buffered value of the \c CustomInsertKeyText property</em>
		CAtlString customInsertKeyText;
		/// \brief <em>The buffered value of the \c CustomKanaLockText property</em>
		CAtlString customKanaLockText;
		/// \brief <em>The buffered value of the \c CustomNumLockText property</em>
		CAtlString customNumLockText;
		/// \brief <em>The buffered value of the \c CustomScrollLockText property</em>
		CAtlString customScrollLockText;

		Properties()
		{
			propertyToEdit = -1;
			selectedPropertyItemID = -1;
			customCapsLockText = TEXT("");
			customInsertKeyText = TEXT("");
			customKanaLockText = TEXT("");
			customNumLockText = TEXT("");
			customScrollLockText = TEXT("");
		}
	} properties;
