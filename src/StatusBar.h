...
/// \brief <em>Superclasses \c msctls_statusbar32</em>
///
/// This class superclasses \c msctls_statusbar32 and makes it accessible by COM.
///
/// \todo Initialize to bottom-alignment.
/// \todo Recognize changes to the \c Align property and recreate the control window.
/// \todo The size gripper is missing after the system's theme was changed.
/// \todo Move the OLE drag'n'drop flags into their own struct?
///
/// \if UNICODE
///   \sa StatBarLibU::IStatusBar
/// \else
///   \sa StatBarLibA::IStatusBar
/// \endif
//////////////////////////////////////////////////////////////////////
...
#include "res/resource.h"
	...
	#include "StatBarA.h"
#endif
#include "_IStatusBarEvents_CP.h"
...
class ATL_NO_VTABLE StatusBar : 
    public CComObjectRootEx<CComSingleThreadModel>,
    #ifdef UNICODE
    	public IDispatchImpl<IStatusBar, &IID_IStatusBar, &LIBID_StatBarLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IDispatchImpl<IStatusBar, &IID_IStatusBar, &LIBID_StatBarLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPersistStreamInitImpl<StatusBar>,
    public IOleControlImpl<StatusBar>,
    public IOleObjectImpl<StatusBar>,
    public IOleInPlaceActiveObjectImpl<StatusBar>,
    public IViewObjectExImpl<StatusBar>,
    public IOleInPlaceObjectWindowlessImpl<StatusBar>,
    public ISupportErrorInfo,
    public IConnectionPointContainerImpl<StatusBar>,
    public Proxy_IStatusBarEvents<StatusBar>,
    public IPersistStorageImpl<StatusBar>,
    public IPersistPropertyBagImpl<StatusBar>,
    public ISpecifyPropertyPages,
    public IQuickActivateImpl<StatusBar>,
    #ifdef UNICODE
    	public IProvideClassInfo2Impl<&CLSID_StatusBar, &__uuidof(_IStatusBarEvents), &LIBID_StatBarLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IProvideClassInfo2Impl<&CLSID_StatusBar, &__uuidof(_IStatusBarEvents), &LIBID_StatBarLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPropertyNotifySinkCP<StatusBar>,
    public CComCoClass<StatusBar, &CLSID_StatusBar>,
    public CComControl<StatusBar>,
    public IPerPropertyBrowsingImpl<StatusBar>,
    public IDropTarget,
    public ICategorizeProperties,
    public ICreditsProvider
{
	friend class StatusBarPanel;
...
public:
	...
	~StatusBar();
		...
		#ifdef UNICODE
			DECLARE_WND_SUPERCLASS(TEXT("StatusBarU"), STATUSCLASSNAMEW)
		#else
			DECLARE_WND_SUPERCLASS(TEXT("StatusBarA"), STATUSCLASSNAMEA)
		#endif
		...
		BEGIN_PROP_MAP(StatusBar)
		END_PROP_MAP()

		BEGIN_CONNECTION_POINT_MAP(StatusBar)
			CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
			CONNECTION_POINT_ENTRY(__uuidof(_IStatusBarEvents))
		...
		BEGIN_MSG_MAP(StatusBar)
			...
			MESSAGE_HANDLER(WM_SETCURSOR, OnSetCursor)     // TODO: Should we use NM_SETCURSOR instead?
			...
			MESSAGE_HANDLER(SB_SETMINHEIGHT, OnSetMinHeight)
			...
			REFLECTED_NOTIFY_CODE_HANDLER(SBN_SIMPLEMODECHANGE, OnSimpleModeChangeNotification)

			CHAIN_MSG_MAP(CComControl<StatusBar>)
		END_MSG_MAP()
	#endif
	...
	//////////////////////////////////////////////////////////////////////
	/// \name Implementation of IStatusBar
	///
	//@{
	...
	///
	/// \if UNICODE
	///   \sa put_Appearance, get_BorderStyle, StatBarLibU::AppearanceConstants
	/// \else
	///   \sa put_Appearance, get_BorderStyle, StatBarLibA::AppearanceConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_Appearance, put_BorderStyle, StatBarLibU::AppearanceConstants
	/// \else
	///   \sa get_Appearance, put_BorderStyle, StatBarLibA::AppearanceConstants
	/// \endif
	...
	///
	/// Retrieves the control's background color. If set to -1, the system's default color is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_BackColor, StatusBarPanel::get_ForeColor
	virtual HRESULT STDMETHODCALLTYPE get_BackColor(OLE_COLOR* pValue);
	/// \brief <em>Sets the \c BackColor property</em>
	///
	/// Sets the control's background color. If set to -1, the system's default color is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_BackColor, StatusBarPanel::put_ForeColor
	...
	///
	/// \if UNICODE
	///   \sa put_BorderStyle, get_Appearance, StatusBarPanel::get_BorderStyle,
	///       StatBarLibU::BorderStyleConstants
	/// \else
	///   \sa put_BorderStyle, get_Appearance, StatusBarPanel::get_BorderStyle,
	///       StatBarLibA::BorderStyleConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_BorderStyle, put_Appearance, StatusBarPanel::put_BorderStyle,
	///       StatBarLibU::BorderStyleConstants
	/// \else
	///   \sa get_BorderStyle, put_Appearance, StatusBarPanel::put_BorderStyle,
	///       StatBarLibA::BorderStyleConstants
	...
	/// \brief <em>Retrieves the current setting of the \c CustomCapsLockText property</em>
	///
	/// Retrieves the text being used for panels whose \c Content property is set to \c pcCapsLock.
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa put_CustomCapsLockText, StatusBarPanel::get_Content, StatusBarPanel::get_Text,
	///     get_CustomInsertKeyText, get_CustomKanaLockText, get_CustomNumLockText, get_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE get_CustomCapsLockText(BSTR* pValue);
	/// \brief <em>Sets the \c CustomCapsLockText property</em>
	///
	/// Sets the text being used for panels whose \c Content property is set to \c pcCapsLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_CustomCapsLockText, StatusBarPanel::put_Content, StatusBarPanel::put_Text,
	///     put_CustomInsertKeyText, put_CustomKanaLockText, put_CustomNumLockText, put_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE put_CustomCapsLockText(BSTR newValue);
	/// \brief <em>Retrieves the current setting of the \c CustomInsertKeyText property</em>
	///
	/// Retrieves the text being used for panels whose \c Content property is set to \c pcInsertKey.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_CustomInsertKeyText, StatusBarPanel::get_Content, StatusBarPanel::get_Text,
	///     get_CustomCapsLockText, get_CustomKanaLockText, get_CustomNumLockText, get_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE get_CustomInsertKeyText(BSTR* pValue);
	/// \brief <em>Sets the \c CustomInsertKeyText property</em>
	///
	/// Sets the text being used for panels whose \c Content property is set to \c pcInsertKey.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_CustomInsertKeyText, StatusBarPanel::put_Content, StatusBarPanel::put_Text,
	///     put_CustomCapsLockText, put_CustomKanaLockText, put_CustomNumLockText, put_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE put_CustomInsertKeyText(BSTR newValue);
	/// \brief <em>Retrieves the current setting of the \c CustomKanaLockText property</em>
	///
	/// Retrieves the text being used for panels whose \c Content property is set to \c pcKanaLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_CustomKanaLockText, StatusBarPanel::get_Content, StatusBarPanel::get_Text,
	///     get_CustomCapsLockText, get_CustomInsertKeyText, get_CustomNumLockText, get_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE get_CustomKanaLockText(BSTR* pValue);
	/// \brief <em>Sets the \c CustomKanaLockText property</em>
	///
	/// Sets the text being used for panels whose \c Content property is set to \c pcKanaLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_CustomKanaLockText, StatusBarPanel::put_Content, StatusBarPanel::put_Text,
	///     put_CustomCapsLockText, put_CustomInsertKeyText, put_CustomNumLockText, put_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE put_CustomKanaLockText(BSTR newValue);
	/// \brief <em>Retrieves the current setting of the \c CustomNumLockText property</em>
	///
	/// Retrieves the text being used for panels whose \c Content property is set to \c pcNumLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_CustomNumLockText, StatusBarPanel::get_Content, StatusBarPanel::get_Text,
	///     get_CustomCapsLockText, get_CustomInsertKeyText, get_CustomKanaLockText, get_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE get_CustomNumLockText(BSTR* pValue);
	/// \brief <em>Sets the \c CustomNumLockText property</em>
	///
	/// Sets the text being used for panels whose \c Content property is set to \c pcNumLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_CustomNumLockText, StatusBarPanel::put_Content, StatusBarPanel::put_Text,
	///     put_CustomCapsLockText, put_CustomInsertKeyText, put_CustomKanaLockText, put_CustomScrollLockText
	virtual HRESULT STDMETHODCALLTYPE put_CustomNumLockText(BSTR newValue);
	/// \brief <em>Retrieves the current setting of the \c CustomScrollLockText property</em>
	///
	/// Retrieves the text being used for panels whose \c Content property is set to \c pcScrollLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_CustomScrollLockText, StatusBarPanel::get_Content, StatusBarPanel::get_Text,
	///     get_CustomCapsLockText, get_CustomInsertKeyText, get_CustomKanaLockText, get_CustomNumLockText
	virtual HRESULT STDMETHODCALLTYPE get_CustomScrollLockText(BSTR* pValue);
	/// \brief <em>Sets the \c CustomScrollLockText property</em>
	///
	/// Sets the text being used for panels whose \c Content property is set to \c pcScrollLock.
	/// If set to an empty string, the key's localized name is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_CustomScrollLockText, StatusBarPanel::put_Content, StatusBarPanel::put_Text,
	///     put_CustomCapsLockText, put_CustomInsertKeyText, put_CustomKanaLockText, put_CustomNumLockText
	virtual HRESULT STDMETHODCALLTYPE put_CustomScrollLockText(BSTR newValue);
	...
	///
	/// \if UNICODE
	///   \sa put_DisabledEvents, StatBarLibU::DisabledEventsConstants
	/// \else
	///   \sa put_DisabledEvents, StatBarLibA::DisabledEventsConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_DisabledEvents, StatBarLibU::DisabledEventsConstants
	/// \else
	///   \sa get_DisabledEvents, StatBarLibA::DisabledEventsConstants
	/// \endif
	...
	///
	/// Retrieves the control's font. It's used to draw the panels' text.
	///
	/// \param[out] ppFont Receives the font object's \c IFontDisp implementation.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_Font, putref_Font, get_UseSystemFont, StatusBarPanel::get_Text,
	...
	///
	/// Sets the control's font. It's used to draw the panels' text.
	///
	...
	///
	/// \sa get_Font, putref_Font, put_UseSystemFont, StatusBarPanel::put_Text,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms692695.aspx">IFontDisp</a>
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa get_Font, put_Font, put_UseSystemFont, StatusBarPanel::put_Text,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms692695.aspx">IFontDisp</a>
	virtual HRESULT STDMETHODCALLTYPE putref_Font(IFontDisp* pNewFont);
	/// \brief <em>Retrieves the current setting of the \c ForceSizeGripperDisplay property</em>
	///
	/// Retrieves whether the control displays the size gripper in situations where the parent window's
	/// and the control's window styles would lead to the size gripper not being displayed.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_ForceSizeGripperDisplay
	virtual HRESULT STDMETHODCALLTYPE get_ForceSizeGripperDisplay(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c ForceSizeGripperDisplay property</em>
	///
	/// Sets whether the control displays the size gripper in situations where the parent window's
	/// and the control's window styles would lead to the size gripper not being displayed.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	///
	/// \sa get_ForceSizeGripperDisplay
	virtual HRESULT STDMETHODCALLTYPE put_ForceSizeGripperDisplay(VARIANT_BOOL newValue);
	...
	///
	/// Retrieves the minimum height (in pixels) of the control's drawing area.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	///
	/// \if UNICODE
	///   \sa put_MouseIcon, putref_MouseIcon, get_MousePointer, StatBarLibU::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \else
	///   \sa put_MouseIcon, putref_MouseIcon, get_MousePointer, StatBarLibA::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_MouseIcon, putref_MouseIcon, put_MousePointer, StatBarLibU::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \else
	///   \sa get_MouseIcon, putref_MouseIcon, put_MousePointer, StatBarLibA::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_MouseIcon, put_MouseIcon, put_MousePointer, StatBarLibU::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \else
	///   \sa get_MouseIcon, put_MouseIcon, put_MousePointer, StatBarLibA::MousePointerConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms680762.aspx">IPictureDisp</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa put_MousePointer, get_MouseIcon, StatBarLibU::MousePointerConstants
	/// \else
	///   \sa put_MousePointer, get_MouseIcon, StatBarLibA::MousePointerConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_MousePointer, put_MouseIcon, StatBarLibU::MousePointerConstants
	/// \else
	///   \sa get_MousePointer, put_MouseIcon, StatBarLibA::MousePointerConstants
	/// \endif
	virtual HRESULT STDMETHODCALLTYPE put_MousePointer(MousePointerConstants newValue);
	/// \brief <em>Retrieves the current setting of the \c Panels property</em>
	///
	/// Retrieves a collection object wrapping the control's panels.
	///
	/// \param[out] ppPanels Receives the collection object's \c IStatusBarPanels implementation.
	///
	/// \return An \c HRESULT error code.
	///
	/// \remarks This property is read-only.
	///
	/// \sa StatusBarPanels
	virtual HRESULT STDMETHODCALLTYPE get_Panels(IStatusBarPanels** ppPanels);
	/// \brief <em>Retrieves the current setting of the \c PanelToAutoSize property</em>
	///
	/// Retrieves the panel whose width is changed automatically so that it fills up the remaining
	/// space. If set to \c NULL, no panel is sized automatically.
	///
	/// \param[out] ppPanel Receives the auto-sized panel's \c IStatusBarPanel implementation.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa putref_PanelToAutoSize, get_Panels, StatusBarPanel::get_PreferredWidth
	virtual HRESULT STDMETHODCALLTYPE get_PanelToAutoSize(IStatusBarPanel** ppPanel);
	/// \brief <em>Sets the \c PanelToAutoSize property</em>
	///
	/// Sets the panel whose width is changed automatically so that it fills up the remaining
	/// space. If set to \c NULL, no panel is sized automatically.
	///
	/// \param[in] pPanel The panel to auto-size.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_PanelToAutoSize, get_Panels, StatusBarPanel::put_PreferredWidth
	virtual HRESULT STDMETHODCALLTYPE putref_PanelToAutoSize(IStatusBarPanel* pPanel);
	...
	/// to left (e. g. the size gripper will be displayed at the control's left border); otherwise
	/// it is left to right.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_RightToLeftLayout, StatusBarPanel::get_RightToLeftText
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa get_RightToLeftLayout, StatusBarPanel::put_RightToLeftText
	...
	///
	/// Enables or disables tooltips. If set to \c VARIANT_TRUE, the control displays panel-specific
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa put_ShowToolTips, StatusBarPanel::get_ToolTipText, Raise_SetupToolTipWindow
	...
	/// \attention Changing this property destroys and recreates the control.
	///
	/// \sa get_ShowToolTips, StatusBarPanel::put_ToolTipText, Raise_SetupToolTipWindow
	virtual HRESULT STDMETHODCALLTYPE put_ShowToolTips(VARIANT_BOOL newValue);
	/// \brief <em>Retrieves the current setting of the \c SimpleMode property</em>
	///
	/// Enables or disables simple mode. In simple mode, the status bar consists of a single panel.
	/// If set to \c VARIANT_TRUE, the control is in simple mode; otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa put_SimpleMode, get_Panels, get_SimplePanel, Raise_ToggledSimpleMode
	virtual HRESULT STDMETHODCALLTYPE get_SimpleMode(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c SimpleMode property</em>
	///
	/// Enables or disables simple mode. In simple mode, the status bar consists of a single panel.
	/// If set to \c VARIANT_TRUE, the control is in simple mode; otherwise not.
	///
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa get_SimpleMode, get_Panels, Raise_ToggledSimpleMode
	virtual HRESULT STDMETHODCALLTYPE put_SimpleMode(VARIANT_BOOL newValue);
	/// \brief <em>Retrieves the current setting of the \c SimplePanel property</em>
	///
	/// Retrieves a \c StatusBarPanel object wrapping the control's default panel that is displayed in
	/// simple mode.
	///
	/// \param[out] ppPanel Receives the object's \c IStatusBarPanel implementation.
	///
	/// \return An \c HRESULT error code.
	///
	/// \remarks This property is read-only.
	///
	/// \sa StatusBarPanel, get_SimpleMode, get_Panels
	virtual HRESULT STDMETHODCALLTYPE get_SimplePanel(IStatusBarPanel** ppPanel);
	...
	///
	/// Retrieves whether the control uses the system's default status bar font or the font specified by the
	...
	///
	/// Sets whether the control uses the system's default status bar font or the font specified by the
	/// \c Font property. If set to \c VARIANT_TRUE, the system font; otherwise the specified font is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	///
	/// \param[out] pHorizontalBorder The size of the control's horizontal border.
	/// \param[out] pVerticalBorder The size of the control's vertical border.
	/// \param[out] pInterPanelBorder The size of each vertical border between the control's panels.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa StatusBarPanel::GetRectangle
	virtual HRESULT STDMETHODCALLTYPE GetBorders(OLE_YSIZE_PIXELS* pHorizontalBorder = NULL, OLE_XSIZE_PIXELS* pVerticalBorder = NULL, OLE_XSIZE_PIXELS* pInterPanelBorder = NULL);
	...
	/// \param[out] ppHitPanel Receives the "hit" panel's \c IStatusBarPanel implementation.
	///
	/// \return An \c HRESULT error code.
	///
	/// \if UNICODE
	///   \sa StatBarLibU::HitTestConstants, HitTest
	/// \else
	///   \sa StatBarLibA::HitTestConstants, HitTest
	/// \endif
	virtual HRESULT STDMETHODCALLTYPE HitTest(OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y, HitTestConstants* pHitTestDetails, IStatusBarPanel** ppHitPanel = NULL);
	...
	/// \brief <em>Call this to apply the panel widths</em>
	///
	/// \param[in] completeUpdate If set to \c TRUE, the method will not only set the panel widths, but
	///            also the panel texts, tooltips, border styles and icons. If set to \c FALSE, only the
	///            panel widths are applied.
	///
	/// \sa StatusBarPanels::Add, StatusBarPanels::Remove, StatusBarPanels::RemoveAll
	void ApplyPanelWidths(BOOL completeUpdate);
	/// \brief <em>Call this to update all panels that monitor a key's state or display the current date or time</em>
	///
	/// \sa OnTimer, StatusBarPanel::put_Content
	void UpdatePredefinedPanels(void);
	/// \brief <em>Retrieves the \c StatusBarPanel object with the specified index</em>
	///
	/// \param[in] panelIndex The index of the panel object to retrieve.
	///
	/// \return A smart pointer to the panel object's \c IStatusBarPanel implementation.
	///
	/// \sa StatusBarPanels::get_Item
	CComPtr<IStatusBarPanel> GetPanelObject(int panelIndex);
	/// \brief <em>Retrieves the \c StatusBarPanel object with the specified index</em>
	///
	/// \param[in] panelIndex The index of the panel object to retrieve.
	/// \param[out] ppPanel Receives the panel object's \c IStatusBarPanel implementation.
	///
	/// \sa StatusBarPanels::get_Item
	void GetPanelObject(int panelIndex, IStatusBarPanel** ppPanel);
...
protected:
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa CommonProperties, StringProperties, PanelProperties,
	...
	/// We use this handler mainly to update predefined panels.
	///
	/// \sa UpdatePredefinedPanels,
	...
	///
	/// Will be called if the control's parent window is asked to draw a panel.
	/// We use this handler to raise the \c OwnerDrawPanel event and to support various panel properties
	/// like \c Alignment and \c Enabled.
	///
	/// \sa StatusBarPanel::get_Alignment, StatusBarPanel::get_Enabled, Raise_OwnerDrawPanel,
	...
	/// \brief <em>\c SB_SETMINHEIGHT handler</em>
	///
	/// Will be called if the minimum height of the control's drawing area shall be changed.
	/// We use this handler to synchronize our cached settings.
	///
	/// \sa get_MinimumHeight,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms651144.aspx">SB_SETMINHEIGHT</a>
	LRESULT OnSetMinHeight(UINT message, WPARAM wParam, LPARAM lParam, BOOL& /*wasHandled*/);
	//@}
	//////////////////////////////////////////////////////////////////////
	...
	/// \brief <em>\c SBN_SIMPLEMODECHANGE handler</em>
	///
	/// Will be called if the control's parent window is notified, that the \c SimpleMode property was
	/// changed.
	/// We use this handler to raise the \c PanelMouseEnter, \c PanelMouseLeave and \c ToggledSimpleMode
	/// events.
	///
	/// \sa put_SimpleMode, Raise_PanelMouseEnter, Raise_PanelMouseLeave, Raise_ToggledSimpleMode,
	///     <a href="https://msdn.microsoft.com/en-us/library/bb760740.aspx">SBN_SIMPLEMODECHANGE</a>
	LRESULT OnSimpleModeChangeNotification(int /*controlID*/, LPNMHDR /*pNotificationDetails*/, BOOL& /*wasHandled*/);
	//@}
	//////////////////////////////////////////////////////////////////////
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_Click, StatBarLibU::_IStatusBarEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_Click, StatBarLibA::_IStatusBarEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_ContextMenu, StatBarLibU::_IStatusBarEvents::ContextMenu,
	///       Raise_RClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_ContextMenu, StatBarLibA::_IStatusBarEvents::ContextMenu,
	///       Raise_RClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_DblClick, StatBarLibU::_IStatusBarEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_DblClick, StatBarLibA::_IStatusBarEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_DestroyedControlWindow,
	///       StatBarLibU::_IStatusBarEvents::DestroyedControlWindow, Raise_RecreatedControlWindow, get_hWnd
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_DestroyedControlWindow,
	///       StatBarLibA::_IStatusBarEvents::DestroyedControlWindow, Raise_RecreatedControlWindow, get_hWnd
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MClick, StatBarLibU::_IStatusBarEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MClick, StatBarLibA::_IStatusBarEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MDblClick, StatBarLibU::_IStatusBarEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MDblClick, StatBarLibA::_IStatusBarEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseDown, StatBarLibU::_IStatusBarEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseDown, StatBarLibA::_IStatusBarEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseEnter, StatBarLibU::_IStatusBarEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_PanelMouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseEnter, StatBarLibA::_IStatusBarEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_PanelMouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseHover, StatBarLibU::_IStatusBarEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseHover, StatBarLibA::_IStatusBarEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseLeave, StatBarLibU::_IStatusBarEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_PanelMouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseLeave, StatBarLibA::_IStatusBarEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_PanelMouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseMove, StatBarLibU::_IStatusBarEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseMove, StatBarLibA::_IStatusBarEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_MouseUp, StatBarLibU::_IStatusBarEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_MouseUp, StatBarLibA::_IStatusBarEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragDrop, StatBarLibU::_IStatusBarEvents::OLEDragDrop,
	...
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragDrop, StatBarLibA::_IStatusBarEvents::OLEDragDrop,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_MouseUp,
	///       get_RegisterForOLEDragDrop, FinishOLEDragDrop,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragEnter, StatBarLibU::_IStatusBarEvents::OLEDragEnter,
	///       Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragEnter, StatBarLibA::_IStatusBarEvents::OLEDragEnter,
	///       Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragLeave, StatBarLibU::_IStatusBarEvents::OLEDragLeave,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragDrop, Raise_MouseLeave
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragLeave, StatBarLibA::_IStatusBarEvents::OLEDragLeave,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragDrop, Raise_MouseLeave
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragMouseMove,
	///       StatBarLibU::_IStatusBarEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_OLEDragMouseMove,
	///       StatBarLibA::_IStatusBarEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	inline HRESULT Raise_OLEDragMouseMove(DWORD* pEffect, DWORD keyState, POINTL mousePosition);
	/// \brief <em>Raises the \c OwnerDrawPanel event</em>
	///
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_OwnerDrawPanel, StatBarLibU::_IStatusBarEvents::OwnerDrawPanel
	///       StatusBarPanel::get_Content, StatBarLibU::RECTANGLE
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_OwnerDrawPanel, StatBarLibA::_IStatusBarEvents::OwnerDrawPanel,
	///       StatusBarPanel::get_Content, StatBarLibA::RECTANGLE
	/// \endif
	inline HRESULT Raise_OwnerDrawPanel(IStatusBarPanel* pPanel, LONG hDC, RECTANGLE* pDrawingRectangle);
	/// \brief <em>Raises the \c PanelMouseEnter event</em>
	///
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_PanelMouseEnter, StatBarLibU::_IStatusBarEvents::PanelMouseEnter,
	///       Raise_PanelMouseLeave, Raise_MouseMove, StatBarLibU::HitTestConstants
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_PanelMouseEnter, StatBarLibA::_IStatusBarEvents::PanelMouseEnter,
	///       Raise_PanelMouseLeave, Raise_MouseMove, StatBarLibA::HitTestConstants
	/// \endif
	inline HRESULT Raise_PanelMouseEnter(IStatusBarPanel* pPanel, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y, UINT hitTestDetails);
	/// \brief <em>Raises the \c PanelMouseLeave event</em>
	///
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_PanelMouseLeave, StatBarLibU::_IStatusBarEvents::PanelMouseLeave,
	///       Raise_PanelMouseEnter, Raise_MouseMove, StatBarLibU::HitTestConstants
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_PanelMouseLeave, StatBarLibA::_IStatusBarEvents::PanelMouseLeave,
	///       Raise_PanelMouseEnter, Raise_MouseMove, StatBarLibA::HitTestConstants
	/// \endif
	inline HRESULT Raise_PanelMouseLeave(IStatusBarPanel* pPanel, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y, UINT hitTestDetails);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_RClick, StatBarLibU::_IStatusBarEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_RClick, StatBarLibA::_IStatusBarEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_RDblClick, StatBarLibU::_IStatusBarEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_RDblClick, StatBarLibA::_IStatusBarEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_RecreatedControlWindow,
	///       StatBarLibU::_IStatusBarEvents::RecreatedControlWindow, Raise_DestroyedControlWindow, get_hWnd
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_RecreatedControlWindow,
	///       StatBarLibA::_IStatusBarEvents::RecreatedControlWindow, Raise_DestroyedControlWindow, get_hWnd
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_ResizedControlWindow,
	///       StatBarLibU::_IStatusBarEvents::ResizedControlWindow
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_ResizedControlWindow,
	///       StatBarLibA::_IStatusBarEvents::ResizedControlWindow
	/// \endif
	inline HRESULT Raise_ResizedControlWindow(void);
	/// \brief <em>Raises the \c SetupToolTipWindow event</em>
	///
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_SetupToolTipWindow,
	///       StatBarLibU::_IStatusBarEvents::SetupToolTipWindow, get_ShowToolTips,
	///       StatusBarPanel::get_ToolTipText
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_SetupToolTipWindow,
	///       StatBarLibA::_IStatusBarEvents::SetupToolTipWindow, get_ShowToolTips,
	///       StatusBarPanel::get_ToolTipText
	/// \endif
	inline HRESULT Raise_SetupToolTipWindow(IStatusBarPanel* pPanel, LONG hWndToolTip);
	/// \brief <em>Raises the \c ToggledSimpleMode event</em>
	///
	/// \return An \c HRESULT error code.
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_ToggledSimpleMode,
	///       StatBarLibU::_IStatusBarEvents::ToggledSimpleMode
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_ToggledSimpleMode,
	///       StatBarLibA::_IStatusBarEvents::ToggledSimpleMode
	/// \endif
	inline HRESULT Raise_ToggledSimpleMode(void);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_XClick, StatBarLibU::_IStatusBarEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_XClick, StatBarLibA::_IStatusBarEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IStatusBarEvents::Fire_XDblClick, StatBarLibU::_IStatusBarEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick
	/// \else
	///   \sa Proxy_IStatusBarEvents::Fire_XDblClick, StatBarLibA::_IStatusBarEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick
	/// \endif
	...
	/// \brief <em>Increments the \c internalSBSIMPLE flag</em>
	///
	/// \sa LeaveInternalSBSIMPLESection, Flags::internalSBSIMPLE, StatusBarPanels::Add,
	///     StatusBarPanels::Remove, StatusBarPanel::get_BorderStyle, StatusBarPanel::put_BorderStyle,
	///     StatusBarPanel::get_Text, StatusBarPanel::put_Text, StatusBarPanel::GetRectangle
	void EnterInternalSBSIMPLESection(void);
	/// \brief <em>Decrements the \c internalSBSIMPLE flag</em>
	///
	/// \sa EnterInternalSBSIMPLESection, Flags::internalSBSIMPLE, StatusBarPanels::Add,
	///     StatusBarPanels::Remove, StatusBarPanel::get_BorderStyle, StatusBarPanel::put_BorderStyle,
	///     StatusBarPanel::get_Text, StatusBarPanel::put_Text, StatusBarPanel::GetRectangle
	void LeaveInternalSBSIMPLESection(void);
	...
	/// settings.
	///
	/// \return A bit field of \c WS_* and \c SBARS_* constants specifying the required window styles.
	///
	...
	///
	/// Sends \c WM_* and \c SB_* messages to the control window to make it match the current property
	...
	///
	/// \if UNICODE
	///   \sa StatBarLibU::MousePointerConstants, OnSetCursor, put_MousePointer
	/// \else
	///   \sa StatBarLibA::MousePointerConstants, OnSetCursor, put_MousePointer
	/// \endif
	...
	/// \brief <em>Hit-tests the specified point</em>
	///
	/// Retrieves the panel that lies below the point ('x'; 'y').
	///
	/// \param[in] x The x-coordinate (in pixels) of the point to check. It must be relative to the control's
	///            upper-left corner.
	/// \param[in] y The y-coordinate (in pixels) of the point to check. It must be relative to the control's
	///            upper-left corner.
	/// \param[out] pFlags A bit field of SBARHT_* flags, that holds further details about the control's
	///             part below the specified point.
	///
	/// \return The "hit" panel's index.
	///
	/// \sa HitTest
	int HitTest(LONG x, LONG y, LPUINT pFlags);
	...
	typedef struct Properties
	{
		...
		public:
			...
			CComObject< PropertyNotifySinkImpl<StatusBar> >* pPropertyNotifySink;
			...
			HRESULT InitializePropertyWatcher(StatusBar* pObjectToNotify, DISPID propertyToWatch)
			{
				CComObject< PropertyNotifySinkImpl<StatusBar> >::CreateInstance(&pPropertyNotifySink);
		...
		OLE_COLOR backColor;
		/// \brief <em>Holds the \c CustomCapsLockText property's setting</em>
		///
		/// \sa get_CustomCapsLockText, put_CustomCapsLockText
		CComBSTR customCapsLockText;
		/// \brief <em>Holds the \c CustomInsertKeyText property's setting</em>
		///
		/// \sa get_CustomInsertKeyText, put_CustomInsertKeyText
		CComBSTR customInsertKeyText;
		/// \brief <em>Holds the \c CustomKanaLockText property's setting</em>
		///
		/// \sa get_CustomKanaLockText, put_CustomKanaLockText
		CComBSTR customKanaLockText;
		/// \brief <em>Holds the \c CustomNumLockText property's setting</em>
		///
		/// \sa get_CustomNumLockText, put_CustomNumLockText
		CComBSTR customNumLockText;
		/// \brief <em>Holds the \c CustomScrollLockText property's setting</em>
		///
		/// \sa get_CustomScrollLockText, put_CustomScrollLockText
		...
		FontProperty font;
		/// \brief <em>Holds the \c ForceSizeGripperDisplay property's setting</em>
		///
		/// \sa get_ForceSizeGripperDisplay, put_ForceSizeGripperDisplay
		UINT forceSizeGripperDisplay : 1;
		/// \brief <em>Holds the \c HoverTime property's setting</em>
		///
		/// \sa get_HoverTime, put_HoverTime
		long hoverTime;
		/// \brief <em>Holds the \c MinimumHeight property's setting</em>
		///
		/// \sa get_MinimumHeight, put_MinimumHeight
		...
		/// \brief <em>Holds the \c Panels property's setting</em>
		///
		/// \sa get_Panels
		CComObject<StatusBarPanels>* panels;
		/// \brief <em>Holds the \c PanelToAutoSize property's setting</em>
		///
		/// \sa get_PanelToAutoSize, putref_PanelToAutoSize
		CComPtr<IStatusBarPanel> panelToAutoSize;
		...
		UINT showToolTips : 1;
		/// \brief <em>Holds the \c SimpleMode property's setting</em>
		///
		/// \sa get_SimpleMode, put_SimpleMode
		UINT simpleMode : 1;
		/// \brief <em>Holds the \c SimplePanel property's setting</em>
		///
		/// \sa get_SimplePanel
		CComObject<StatusBarPanel>* simplePanel;
		...
		void ResetToDefaults(void)
		{
			...
			backColor = CLR_NONE;
			borderStyle = bsNone;
			customCapsLockText = L"";
			customInsertKeyText = L"";
			customKanaLockText = L"";
			customNumLockText = L"";
			customScrollLockText = L"";
			disabledEvents = static_cast<DisabledEventsConstants>(deMouseEvents | deClickEvents | deSetupToolTipWindow);
			dontRedraw = FALSE;
			enabled = TRUE;
			forceSizeGripperDisplay = FALSE;
			hoverTime = -1;
			minimumHeight = 0;
			mousePointer = mpDefault;
			panelToAutoSize = NULL;
	...
	struct Flags
	{
		...
		/// \sa OnThemeChanged
		UINT usingThemes : 1;
		/// \brief <em>If not 0, \c OnSimpleModeChangeNotification won't raise any events</em>
		///
		/// \sa EnterInternalSBSIMPLESection, LeaveInternalSBSIMPLESection, OnSimpleModeChangeNotification
		int internalSBSIMPLE;
	...
	/// \brief <em>Holds the index of the panel below the mouse cursor</em>
	///
	/// \remarks A value of -1 identifies the simple mode panel.
	///
	...
	public:
		...
		/// \attention This member is not reliable with \c deMouseEvents being set.
		POINT lastPosition;
		/// \brief <em>Holds the index of the last clicked panel</em>
		///
		/// Holds the index of the last clicked panel. We use this to ensure that the \c *DblClick events
		...
		int lastClickedPanel;
		/// \brief <em>Holds the index of the panel over which the mouse was pressed</em>
		///
		/// Holds the index of the panel over which the mouse was pressed. We use this to ensure that the
		/// \c *Click events are not raised accidently.
		///
		/// \sa Raise_Click, Raise_MClick, Raise_RClick, Raise_MouseDown, Raise_MouseUp
		int mouseDownPanel;
	...
	static struct Timers
	{
		...
		/// \brief <em>The ID of the timer that is used to check predefined panels for updates</em>
		static const UINT_PTR ID_CHECKPANELS = 17;

		/// \brief <em>The interval of the timer that is used to redraw the control after recreation</em>
		static const UINT INT_REDRAW = 10;
		/// \brief <em>The interval of the timer that is used to check predefined panels for updates</em>
		static const UINT INT_CHECKPANELS = 250;
	} timers;
...
OBJECT_ENTRY_AUTO(__uuidof(StatusBar), StatusBar)